# Generated by Django 5.0.2 on 2024-02-22 21:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('P_ID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='receptionist_app.patientchange')),
            ],
        ),
        migrations.CreateModel(
            name='PatientHistory',
            fields=[
                ...
                ('PatientID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='receptionist_app.patientchange')),
            ],
        ),
        migrations.CreateModel(
            name='Prescription',
