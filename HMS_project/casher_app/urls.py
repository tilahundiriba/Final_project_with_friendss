...
urlpatterns = [
  ...
  path('card_payments/', views.card_payments, name='card_payments'),
  ...
  path('checked_payment_request/<str:lab_number>/', checked_payment_request, name='checked_payment_request'),
