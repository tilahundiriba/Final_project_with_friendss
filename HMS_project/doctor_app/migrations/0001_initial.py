    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Doctor_ID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_app.userprofileinfo2')),
                ('PatientID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='receptionist_app.patientregister')),
                ('Technician_ID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='laboratory_send_set', related_query_name='laboratory_send_set', to='admin_app.userprofileinfo2')),
            ],
        ),
        migrations.CreateModel(
            name='Appointment',
